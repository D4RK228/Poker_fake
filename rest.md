...
*(Это нужно чтобы игрок, который пошел ва-банк не купил себе лишний porsche)
3. exchange - Выявляет победителя внутри каждого пота
*(Если их несколько, выигрыш делится поровну)
```python

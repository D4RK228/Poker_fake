# Набор фунций, который выявляет сильнейшую комбинацию игрока
1. player - номер игрока, комбинацию которого нужно проверить
2. data_cards - массив карт (5 карт на столе + 2 карты в руке игрока)
3. k_player - кол-во игроков
